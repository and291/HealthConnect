...
@Composable
internal fun PowerSampleFieldEditor(
    model: PowerSampleField,
    ...
    Column(modifier = modifier.padding(8.dp)) {
        Row(
            ...
            Text("Power Sample", style = MaterialTheme.typography.bodyLarge)
        ...
        ValueFieldEditor(
            model = model.power,
            onChanged = { onChanged(model.copy(power = it)) },
            modifier = Modifier.fillMaxWidth()
        )
        TimeEditor(
            labelText = "Time",
...
@Composable
private fun PowerSampleFieldEditorPreview() {
